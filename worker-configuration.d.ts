/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 5ec69760a7c8d2a844b34ab60cd58473)
// Runtime types generated with workerd@1.20250924.0 2025-05-20 
declare namespace Cloudflare {
	interface Env {
		KV: KVNamespace;
		NUXT_PUBLIC_BASE_URL: string;
		NUXT_ENCRYPTION_HASHIDS: string;
		NUXT_ENCRYPTION_KEY: string;
		NUXT_RESEND_API_KEY: string;
		NUXT_RESEND_SENDER_NOREPLY: string;
		NUXT_RESEND_SENDER_PERSONALIZED: string;
