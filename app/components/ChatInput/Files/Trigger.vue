          ...
          <ul class="menu menu-xs w-full">
            ...
            <li>
              <button
                ...
                type="button"
                @click="openModal('select', 'assistant')"
              >
...
const emit = defineEmits<{
  detachAll: []
  open: [tab: 'select' | 'upload', source?: FileSourceFilter]
}>()
...
function openModal(tab: 'select' | 'upload', source?: FileSourceFilter) {
  closeDropdown()
  emit('open', tab, source)
}
