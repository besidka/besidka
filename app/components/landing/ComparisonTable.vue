      ...
      <thead>
        <tr class="z-20 bg-transparent border-b border-base-content/10">
          ...
          <th
            ...
            :key="colIndex"
            scope="col"
            class="bg-base-100/80 backdrop-blur-lg backdrop-saturate-150
              text-center font-semibold py-2 px-3 min-w-[7rem]"
            :class="colIndex === 0
      ...
      <tbody>
        ...
        >
          ...
          <td
            ...
            :class="colIndex === 0
              ? 'static sm:sticky sm:left-[9.5rem] z-10 bg-base-100/80 '
                + 'backdrop-blur-lg backdrop-saturate-150 text-accent '
                + 'font-medium'
